...
import 'package:planets_movil/feature/planets/presentation/planets_list/planet_list_state.dart';
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Container(
                                    margin: context.fromLTRB(top: .07),
                                ...
                                Container(
                                  margin: context.fromLTRB(left: .05, top: .07),
                                  decoration: const BoxDecoration(
                                    color: secondaryBase,
                                    borderRadius:
